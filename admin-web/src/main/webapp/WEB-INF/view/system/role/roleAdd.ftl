			...
			<form class="layui-form layui-form-pane" action="" id="myForm">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" id="roleName" name="roleName" lay-verify="required" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
				...
				<div class="layui-form-item">
					<div class="layui-input-block">
						<@buttonTag name="保存" menuLink="/system/roleinfo/add" layFilter="mySubmit" class="layui-btn-warm"/>
