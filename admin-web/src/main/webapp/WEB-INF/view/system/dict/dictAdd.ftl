			...
			<form class="layui-form layui-form-pane" action="" id="myForm">
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" id="dictKey" name="dictKey" lay-verify="required" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label"><span class="color-red">*</span>VALUE</label>
					<div class="layui-input-block">
						<input type="text" id="dictValue" name="dictValue" lay-verify="required" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">备注</label>
					<div class="layui-input-block">
						<input type="text" id="comments" name="comments" class="layui-input">
					</div>
				</div>
				
				<div class="layui-form-item">
					<div class="layui-input-block">
						<@buttonTag name="保存" menuLink="/system/dictionary/add" layFilter="mySubmit" class="layui-btn-warm"/>
